...
class TypeTableRender extends TypeRender {
  ...
  Map<String,bool> getCollectionColumns(JSONRender render, NodeKey nodeKey, List<Map> list) {
    // ignore: omit_local_variable_types
  ...
  void extractColumns(JSONRender render, Map map, NodeKey entryNodeKey, Map<String,bool> columns) {
    if (map == null) return ;
